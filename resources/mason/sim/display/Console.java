...
/**
   ...
   <p>While normally you'd start a MASON application by running a DataAssimKotlin.main() method created by the developer,
   ...
   DataAssimKotlin.main display.  If not, then Console puts itself in its default position (typically the top left corner
   of the screeen).
...
public class Console extends JFrame implements Controller
    ...
    public final static int DEFAULT_WIDTH = 580;
    /** Default height of the Console. */
    public final static int DEFAULT_HEIGHT = 580;
    ...
    */
    ...
    static boolean launchClass(JFrame originalFrame, String className)
        ...
        try
            ...
            // doNew() is being called from DataAssimKotlin.main(), and thus from the DataAssimKotlin.main thread rather than the dispatch
        ...
        Runnable run = new Runnable()
            ...
            public void run()
                ...
                try
                    ...
                    // start the DataAssimKotlin.main loop
