...
public class NetworkPortrayal2D extends FieldPortrayal2D
    ...
    protected void hitOrDraw(Graphics2D graphics, DrawInfo2D info, Bag putInHere)
        ...
        if (otherField == null) otherField = field.field;  // I guess not, use the DataAssimKotlin.main field

        Double2D dimensions = field.field.getDimensions();  // dimensions of the DataAssimKotlin.main field
