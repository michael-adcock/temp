...
public class TimeSeriesChartingPropertyInspector extends ChartingPropertyInspector
    ...
    protected void updateSeries(double time, double lastTime)
        ...
        // SECOND, determine if it's time to dump stuff into the DataAssimKotlin.main series
        ...
        // THIRD determine how and when to dump stuff into the DataAssimKotlin.main series
